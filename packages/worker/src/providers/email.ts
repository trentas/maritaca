 ...
 */
export interface EmailProviderSimulation {
  /**
...
export interface EmailProviderOptions {
  logger?: Logger
  simulation?: EmailProviderSimulation
}
...
export class EmailProvider implements Provider {
  ...
  private simulation: EmailProviderSimulation

  constructor(loggerOrOptions?: Logger | EmailProviderOptions) {
   ...
   */
  setSimulation(simulation: EmailProviderSimulation): void {
